...
<html>
    ...
    <body id="nivel">
        ...
        <div class="subMenu">
            <nav>
                <button type="button" id="btnListar" value="tblNivel" class="btnMenu">Mostrar Nivel</button>
            </nav>
        </div>
        <div class="container">
            <div id="divTable">
            ...
            <div id="divFrm">
                <form action="./registrar.php" method="POST" id="frmNivel">
                    <fieldset>
                        <label for="id">ID:</label>
                        <input type="text" name="id" id="id" size="5" disabled /><br />
                        <label for="nome">Nome:</label>
                        <input type="text" name="nome" id="nome" size="50" autofocus required /><br />
                        <label for="descricao">Descrição:</label>
                        <textarea name="descricao" id="descricao" cols="50" rows="5"></textarea>
                    </fieldset>
                    <button type="button" name="gravar" value="nivel" id="btnGravar">Gravar</button>
                    <button type="button" name="editar" value="nivel" id="btnEditar">Editar</button>
